...
public class ImportWmcTest {
    ...
    private User mockedPrincipal = Mockito.mock(User.class);
    ...
    public void setUp() throws Exception {
        ...
        importWmcService.init(Paths.get(System.getenv("GN_HOME")), serviceConfig);
    }
    ...
    public final void testImportWmc() throws Exception {
        ...
        Mockito.when(userSession.getPrincipal()).thenReturn(mockedPrincipal);
